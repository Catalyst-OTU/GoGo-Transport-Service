...
from .passenger import appraisal_comment_router
from .appraisal_cycle import appraisal_cycle_router
from .appraisal_input import appraisal_input_router
from .appraisal_section import appraisal_section_router
...
appraisal_routers.include_router(appraisal_cycle_router, tags=["APPRAISAL CYCLES"])
appraisal_routers.include_router(appraisal_section_router, tags=["APPRAISAL SECTIONS"])
