...
from domains.appraisal.schemas.appraisal_template import AppraisalTemplateSchema, AppraisalTemplateUpdate, AppraisalTemplateCreate
...
class AppraisalTemplateService:
    ...
    def create_appraisal_template(self, db: Session, *, appraisal_template_in: AppraisalTemplateCreate) -> AppraisalTemplateSchema:
        appraisal_template = self.repo.create(db=db, data=appraisal_template_in)
        return appraisal_template

    def update_appraisal_template(self, db: Session, *, id: UUID4, appraisal_template_in: AppraisalTemplateUpdate) -> AppraisalTemplateSchema:
    ...
    def get_appraisal_template(self, db: Session, *, id: UUID4) -> AppraisalTemplateSchema:
        appraisal_template = self.repo.get_by_id(db=db, id=id)
        return appraisal_template

    def delete_appraisal_template(self, db: Session, *, id: UUID4) -> None:
